...
are some zero value because some age groups had more emigrants than
immigrants. These were coerced to zero, under the assumption that old ages
are less likely to migrate._

```{r}
knitr::kable(
  select(can_mig_prop_both, age_group, mig_rate),
  booktabs = TRUE, digits = 3,
  col.names = c("Age group", "Age-specific net migration rate"),
  caption = "Age schedule of age-specific net migration rate (per 1000 people)"
)
```
